...
! function(a, b, c) {
        ...
        a.extend(a.mobile, {
            ...
            resetActivePageHeight: function(b) {
                var c = a("." + a.mobile.activePageClass),
                    e = c.height(),
                    f = c.outerHeight(!0);
                b = d(c, "number" == typeof b ? b : a.mobile.getScreenHeight()), c.css("min-height", b - (f - e))
            },
            loading: function() {
    ...
    function(a, b) {
        ...
        a.each(["animation", "transition"], function(c, g) {
            ...
            return a.support.cssTransitions && "transition" === k || a.support.cssAnimations && "animation" === k ? (g === b && (a(this).context !== c && (i = 3e3 * parseFloat(a(this).css(d[k].duration))), (0 === i || i === b || isNaN(i)) && (i = a.fn.animationComplete.defaultDuration)), h = setTimeout(function() {
            ...
            a.mobile.document.delegate("form", "submit", function(b) {
                ...
                if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                    if (h = a(g), a.data(g, "mobile-button")) {
                        ...
                        if (g = d(g), !g || "#" === a.mobile.path.parseUrl(g.getAttribute("href") || "#").hash) return;
                        if (!a(g).jqmHijackable().length) return
                    }~
                    g.className.indexOf("ui-link-inherit") ? g.parentNode && (f = a.data(g.parentNode, "buttonElements")) : f = a.data(g, "buttonElements"), f ? g = f.outer : i = !0, c = a(g), i && (c = c.closest(".ui-btn")), c.length > 0 && !c.hasClass("ui-state-disabled") && (a.mobile.removeActiveLinkClass(!0), a.mobile.activeClickedLink = c, a.mobile.activeClickedLink.addClass(a.mobile.activeBtnClass))
                }
                ...
                if (a.mobile.linkBindingEnabled && !e.isDefaultPrevented()) {
                    ...
                    if (a.mobile.activeClickedLink && a.mobile.activeClickedLink[0] === e.target.parentNode && p(), n && !(e.which > 1) && o.jqmHijackable().length) {
                        ...
                        if (f = a.mobile.getClosestBaseUrl(o), h = a.mobile.path.makeUrlAbsolute(o.attr("href") || "#", f), !a.mobile.ajaxEnabled && !a.mobile.path.isEmbeddedPage(h)) return void p();
                        if (-1 !== h.search("#")) {
                            if (h = h.replace(/[^#]*#/, ""), !h) return void e.preventDefault();
                            h = a.mobile.path.isPath(h) ? a.mobile.path.makeUrlAbsolute(h, f) : a.mobile.path.makeUrlAbsolute("#" + h, g.hrefNoHash)
                        }
                        if (i = o.is("[rel='external']") || o.is(":jqmData(ajax='false')") || o.is("[target]"), j = i || a.mobile.path.isExternal(h) && !a.mobile.path.isPermittedCrossDomainRequest(g, h)) return void p();
                ...
                f ? f.done(a.mobile.resetActivePageHeight) : a.mobile.resetActivePageHeight()
        ...
        a.widget("mobile.checkboxradio", a.extend({
            ...
            _create: function() {
                var b = this.element,
                    ...
                    g = f.length ? f : b.closest("form, fieldset, :jqmData(role='page'), :jqmData(role='dialog')").find("label").filter("[for='" + c(b[0].id) + "']").first(),
                    h = b[0].type,
                    i = "ui-" + h + "-on",
                    j = "ui-" + h + "-off";
                ("checkbox" === h || "radio" === h) && (this.element[0].disabled && (this.options.disabled = !0), d.iconpos = e(b, "iconpos") || g.attr("data-" + a.mobile.ns + "iconpos") || d.iconpos, d.mini = e(b, "mini") || d.mini, a.extend(this, {
                        input: b,
                        label: g,
                        parentLabel: f,
                        inputtype: h,
                        checkedClass: i,
                        uncheckedClass: j
                    }), this.options.enhanced || this._enhance(), this._on(g, {
            ...
            _getInputSet: function() {
                var b, d, e = this.element[0],
                    ...
                    i = this.element;
                return f && "radio" === this.inputtype && h && (b = "input[type='radio'][name='" + c(f) + "']", g ? (d = g.id, d && (i = a(b + "[form='" + c(d) + "']", h)), i = a(g).find(b).filter(function() {
                    return this.form === g
    ...
    function(a, b) {
        a.widget("mobile.toolbar", {
            ...
            _addBackButton: function() {
                ...
                a("<a role='button' href='javascript:void(0);' class='ui-btn ui-corner-all ui-shadow ui-btn-left " + (c ? "ui-btn-" + c + " " : "") + "ui-toolbar-back-btn ui-icon-carat-l ui-btn-icon-left' data-" + a.mobile.ns + "rel='back'>" + b.backBtnText + "</a>").prependTo(this.element)
            },
    ...
    function(a, c) {
        a.widget("mobile.panel", {
            ...
            _handleClick: function(b) {
                ...
                return b.currentTarget.href.split("#")[1] === e && e !== c ? (b.preventDefault(), d = a(b.target), d.hasClass("ui-btn") && (d.addClass(a.mobile.activeBtnClass), this.element.one("panelopen panelclose", function() {
                ...
                if (!this._open) {
                    var c = this,
                        ...
                        e = function() {
                            ...
                            "overlay" !== d.display && (c._wrapper.addClass(d.classes.pageContentPrefix + "-open"), c._fixedToolbars().addClass(d.classes.pageContentPrefix + "-open")), c._bindFixListener(), c._trigger("open"), c._openedPage = c._page()
                        };
    ...
    function(a) {
        a.widget("mobile.table", a.mobile.table, {
            ...
            _refresh: function(a) {
                this._super(a), a || "columntoggle" !== this.options.mode || (this._unlockCells(this.element.find(".ui-table-cell-hidden, .ui-table-cell-visible")), this._addToggles(this._menu, a), this._setToggleState())
            },
